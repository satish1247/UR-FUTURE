...
export const SITE_TAGLINE = "Jobs and internships in Robotics & Automation";
export const SITE_DESCRIPTION =
  "Fresher jobs, internships and apprenticeships in Robotics & Automation across core, software and non-technical roles, with free learning paths and resume prompts.";
