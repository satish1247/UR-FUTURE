...
const SPECS: SampleSpec[] = [
  ...
  { track: "software", category: "ai-ml-vision", type: "job", title: "Computer Vision Engineer - Fresher", company: "Visiq AI", city: "Bengaluru", state: "Karnataka", workMode: "hybrid", salary: { min: 600000, max: 800000, currency: "INR", period: "year" }, must: ["Python", "OpenCV", "PyTorch"], nice: ["YOLO", "Docker"], stand: ["Deployed defect-detection demo"], learn: [["OpenCV", RES.opencv], ["Python", RES.python]] },
  { track: "software", category: "ai-ml-vision", type: "internship", title: "Generative AI Developer Intern", company: "Promptly Systems", city: "Remote", state: "Karnataka", workMode: "remote", salary: { min: 15000, currency: "INR", period: "stipend-month" }, must: ["Python", "LLM APIs", "Prompt engineering"], nice: ["RAG", "Vector databases"], stand: ["Chatbot over your own notes"], learn: [["Python", RES.python], ["Web basics", RES.fcc]], deadlineInDays: 3 },
  { track: "software", category: "rpa-workflow", type: "job", title: "Workflow Automation Developer (n8n)", company: "FlowForge", city: "Ahmedabad", state: "Gujarat", workMode: "remote", salary: null, must: ["n8n", "REST APIs", "JavaScript"], nice: ["Zapier", "Make"], stand: ["Automated a real college process"], learn: [["n8n", RES.n8n], ["JavaScript", RES.fcc]] },
  { track: "non-technical", category: "technical-sales", type: "job", title: "Technical Sales Engineer - Industrial Robots", company: "Armatech Automation", city: "Delhi NCR", state: "Delhi", workMode: "hybrid", salary: { note: "Fixed + incentives", period: "year", currency: "INR" }, must: ["Technical communication", "Robot applications basics", "Customer handling"], nice: ["CRM tools", "Hindi"], stand: ["Demo video explaining a robot cell"], learn: [["Robotics basics", RES.ocw]] },
  { track: "non-technical", category: "application-support", type: "trainee", title: "Application Support Engineer Trainee", company: "CellSense Robotics", city: "Coimbatore", state: "Tamil Nadu", workMode: "onsite", salary: { min: 20000, max: 25000, currency: "INR", period: "month" }, must: ["Troubleshooting", "Customer communication", "Documentation"], nice: ["Ticketing tools", "Basic PLC"], stand: ["Written troubleshooting guide"], learn: [["Technical writing", RES.fcc]], deadlineInDays: 9 },
